...
public class Paladin extends CharacterAbilities implements ClassDefaults {
    int level;

    public Paladin(int strength, int dexterity, int constitution, int intelligence, int wisdom, int charisma) {
