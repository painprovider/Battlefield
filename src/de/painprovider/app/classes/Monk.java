...
public class Monk extends CharacterAbilities implements ClassDefaults {
    int level;

    public Monk(int strength, int dexterity, int constitution, int intelligence, int wisdom, int charisma) {
