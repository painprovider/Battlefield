...
public class Rogue extends CharacterAbilities implements ClassDefaults {
    int level;

    public Rogue(int strength, int dexterity, int constitution, int intelligence, int wisdom, int charisma) {
