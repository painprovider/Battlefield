...
public class Bard extends CharacterAbilities implements ClassDefaults {
    int level;

    public Bard(int strength, int dexterity, int constitution, int intelligence, int wisdom, int charisma) {
