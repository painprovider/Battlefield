...
public class Cleric extends CharacterAbilities implements ClassDefaults {
    int level;

    public Cleric(int strength, int dexterity, int constitution, int intelligence, int wisdom, int charisma) {
